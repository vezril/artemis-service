...
The pekko-http REST/JSON API that serves the Muses contract — reads from the projections,
writes as entity commands — plus the HTTP media gateway that fronts Apollo for browsers.
