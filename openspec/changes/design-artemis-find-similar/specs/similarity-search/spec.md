...
Tier 1 near-duplicate search over the perceptual hash already stored per post. (Tier 2
embedding/semantic similarity is a documented future enhancement, not specified here.)
