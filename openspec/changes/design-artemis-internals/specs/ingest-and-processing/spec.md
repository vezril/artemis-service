...
Artemis's side of the async media spine: the upload write path, and consuming Hephaestus
results to drive posts to `active`/`failed` — including the post-processing perceptual-dup
warning.
